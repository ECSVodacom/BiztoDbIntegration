...
using Xml.Schema.Linq;
    ...
    /// </para>
    /// </summary>
    public partial class othertaxdoctotal : XTypedElement, IXMetaData
    {
        ...
        public static explicit operator othertaxdoctotal(XElement xe) { return XTypedServices.ToXTypedElement<othertaxdoctotal>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

        static othertaxdoctotal()
        {
        ...
        XName IXMetaData.SchemaName
        {
            get
            {
                return XName.Get("othertaxdoctotal", "");
            }
        }
        ...
        public static othertaxdoctotal Load(string xmlFile)
        {
            return XTypedServices.Load<othertaxdoctotal>(xmlFile);
        }

        public static othertaxdoctotal Load(System.IO.TextReader xmlFile)
        {
            return XTypedServices.Load<othertaxdoctotal>(xmlFile);
        }

        public static othertaxdoctotal Parse(string xml)
        {
            return XTypedServices.Parse<othertaxdoctotal>(xml);
        }

        public override XTypedElement Clone()
        {
            return XTypedServices.CloneXTypedElement<othertaxdoctotal>(this);
        }
    ...
    /// <summary>
    /// <para>
    /// Regular expression: (othertaxdoctotal | remittanceadvice)*
    /// </para>
    /// </summary>
    public partial class remittancedocumentV2 : XTypedElement, IXMetaData
    {

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private XTypedList<othertaxdoctotal> othertaxdoctotalField;
        ...
        public static explicit operator remittancedocumentV2(XElement xe) { return XTypedServices.ToXTypedElement<remittancedocumentV2>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

        static remittancedocumentV2()
        {
            BuildElementDictionary();
        }
        ...
        /// </para>
        /// </summary>
        public IList<othertaxdoctotal> othertaxdoctotal
        {
            get
            {
                if ((this.othertaxdoctotalField == null))
                {
                    this.othertaxdoctotalField = new XTypedList<othertaxdoctotal>(this, LinqToXsdTypeManager.Instance, XName.Get("othertaxdoctotal", ""));
                }
                return this.othertaxdoctotalField;
            }
            set
            {
                if ((value == null))
                {
                    this.othertaxdoctotalField = null;
                }
                else
                {
                    if ((this.othertaxdoctotalField == null))
                    {
                        this.othertaxdoctotalField = XTypedList<othertaxdoctotal>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("othertaxdoctotal", ""));
                    }
                    else
                    {
                        XTypedServices.SetList<othertaxdoctotal>(this.othertaxdoctotalField, value);
                    }
                }
            }
        }
        ...
        /// </para>
        /// </summary>
        public IList<remittancedocumentV2.remittanceadviceLocalType> remittanceadvice
        {
            get
            {
        ...
        XName IXMetaData.SchemaName
        {
            get
            {
                return XName.Get("remittancedocumentV2", "");
            }
        }
        ...
        public static remittancedocumentV2 Load(string xmlFile)
        {
            return XTypedServices.Load<remittancedocumentV2>(xmlFile);
        }

        public static remittancedocumentV2 Load(System.IO.TextReader xmlFile)
        {
            return XTypedServices.Load<remittancedocumentV2>(xmlFile);
        }

        public static remittancedocumentV2 Parse(string xml)
        {
            return XTypedServices.Parse<remittancedocumentV2>(xml);
        }

        public override XTypedElement Clone()
        {
            return XTypedServices.CloneXTypedElement<remittancedocumentV2>(this);
        }

        private static void BuildElementDictionary()
        {
            localElementDictionary.Add(XName.Get("othertaxdoctotal", ""), typeof(othertaxdoctotal));
        ...
        /// <summary>
        /// <para>
        /// Regular expression: (ratype, raheader+, radetails*, totalforpayment*, othertotal*, taxinvoice*, taxcreditnote*)
        /// </para>
        /// </summary>
        public partial class remittanceadviceLocalType : XTypedElement, IXMetaData
        {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private XTypedList<taxcreditnoteLocalType> taxcreditnoteField;
            ...
            {
                BuildElementDictionary();
                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("ratype", "")), new NamedContentModelEntity(XName.Get("raheader", "")), new NamedContentModelEntity(XName.Get("radetails", "")), new NamedContentModelEntity(XName.Get("totalforpayment", "")), new NamedContentModelEntity(XName.Get("othertotal", "")), new NamedContentModelEntity(XName.Get("taxinvoice", "")), new NamedContentModelEntity(XName.Get("taxcreditnote", "")));
            }
            ...
            /// </para>
            /// </summary>
            public IList<remittancedocumentV2.remittanceadviceLocalType.raheaderLocalType> raheader
            {
                get
                {
            ...
            /// </para>
            /// </summary>
            public IList<remittancedocumentV2.remittanceadviceLocalType.radetailsLocalType> radetails
            {
                get
                {
            ...
            /// </para>
            /// </summary>
            public IList<remittancedocumentV2.remittanceadviceLocalType.totalforpaymentLocalType> totalforpayment
            {
                get
                {
            ...
            /// </para>
            /// </summary>
            public IList<remittancedocumentV2.remittanceadviceLocalType.othertotalLocalType> othertotal
            {
                get
                {
            ...
            /// </para>
            /// </summary>
            public IList<remittancedocumentV2.remittanceadviceLocalType.taxinvoiceLocalType> taxinvoice
            {
                get
                {
            ...
            /// </para>
            /// </summary>
            public IList<remittancedocumentV2.remittanceadviceLocalType.taxcreditnoteLocalType> taxcreditnote
            {
                get
                {
                    if ((this.taxcreditnoteField == null))
                    {
                        this.taxcreditnoteField = new XTypedList<taxcreditnoteLocalType>(this, LinqToXsdTypeManager.Instance, XName.Get("taxcreditnote", ""));
                    }
                    return this.taxcreditnoteField;
                }
                set
                {
                    if ((value == null))
                    {
                        this.taxcreditnoteField = null;
                    }
                    else
                    {
                        if ((this.taxcreditnoteField == null))
                        {
                            this.taxcreditnoteField = XTypedList<taxcreditnoteLocalType>.Initialize(this, LinqToXsdTypeManager.Instance, value, XName.Get("taxcreditnote", ""));
                        }
                        else
                        {
                            XTypedServices.SetList<taxcreditnoteLocalType>(this.taxcreditnoteField, value);
                        }
                    }
                }
            }
            ...
            private static void BuildElementDictionary()
            {
                ...
                localElementDictionary.Add(XName.Get("taxcreditnote", ""), typeof(taxcreditnoteLocalType));
            }
            ...
            /// <summary>
            /// <para>
            /// Regular expression: (documentnumber, othertaxdoctotal*)
            /// </para>
            /// </summary>
            public partial class taxinvoiceLocalType : XTypedElement, IXMetaData
            {
                ...
                {
                    BuildElementDictionary();
                    contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("documentnumber", "")), new NamedContentModelEntity(XName.Get("othertaxdoctotal", "")));
                }
            ...
            /// </para>
            /// </summary>
            public partial class taxcreditnoteLocalType : XTypedElement, IXMetaData
            {
                ...
                public static explicit operator taxcreditnoteLocalType(XElement xe) { return XTypedServices.ToXTypedElement<taxcreditnoteLocalType>(xe, LinqToXsdTypeManager.Instance as ILinqToXsdTypeManager); }

                static taxcreditnoteLocalType()
                {
                    BuildElementDictionary();
                    contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("documentnumber", "")), new NamedContentModelEntity(XName.Get("othertaxdoctotal", "")));
                }
                ...
                XName IXMetaData.SchemaName
                {
                    get
                    {
                        return XName.Get("taxcreditnote", "");
                    }
                }
                ...
                public override XTypedElement Clone()
                {
                    return XTypedServices.CloneXTypedElement<taxcreditnoteLocalType>(this);
                }
    ...
    public class LinqToXsdTypeManager : ILinqToXsdTypeManager
    {
        ...
        private static void BuildElementDictionary()
        {
            elementDictionary.Add(XName.Get("othertaxdoctotal", ""), typeof(global:: othertaxdoctotal));
            elementDictionary.Add(XName.Get("remittancedocumentV2", ""), typeof(global:: remittancedocumentV2));
        }
        ...
        {
            return elementDictionary[XName.Get("othertaxdoctotal", "")];
        }
    }
    ...
    public partial class XRootNamespace
    {
        ...
        public othertaxdoctotal othertaxdoctotal { get { return rootObject as othertaxdoctotal; } }

        public remittancedocumentV2 remittancedocumentV2 { get { return rootObject as remittancedocumentV2; } }

        private XRootNamespace()
        {
        }

        public XRootNamespace(othertaxdoctotal root)
        {
            this.doc = new XDocument(root.Untyped);
            this.rootObject = root;
        }

        public XRootNamespace(remittancedocumentV2 root)
        {
            this.doc = new XDocument(root.Untyped);
            this.rootObject = root;
        }
    ...
    public partial class XRoot
    {
        ...
        public XRoot(othertaxdoctotal root)
        {
            this.doc = new XDocument(root.Untyped);
            this.rootObject = root;
        }

        public XRoot(remittancedocumentV2 root)
        {
            this.doc = new XDocument(root.Untyped);
            this.rootObject = root;
        }
