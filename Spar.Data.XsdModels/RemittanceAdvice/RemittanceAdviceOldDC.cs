...
namespace Spar.Data.XsdModels.RemittanceAdvice.OldDC
{
    /// <summary>
    /// <para>
    ...
    public partial class remittancedocument : XTypedElement, IXMetaData
    {
        ...
        /// <summary>
        /// <para>
        /// Regular expression: (invoicenumber, totalallowancededucteddesc, totalallowancededucted, totalvatonallowancededucteddesc, totalvatonallowancededucted, totalinclallodeductedradesc, totalinclallodeductedra)
        /// </para>
        /// </summary>
        public partial class taxinvoiceLocalType : XTypedElement, IXMetaData
        {
            ...
            {
                BuildElementDictionary();
                contentModel = new SequenceContentModelEntity(new NamedContentModelEntity(XName.Get("invoicenumber", "")), new NamedContentModelEntity(XName.Get("totalallowancededucteddesc", "")), new NamedContentModelEntity(XName.Get("totalallowancededucted", "")), new NamedContentModelEntity(XName.Get("totalvatonallowancededucteddesc", "")), new NamedContentModelEntity(XName.Get("totalvatonallowancededucted", "")), new NamedContentModelEntity(XName.Get("totalinclallodeductedradesc", "")), new NamedContentModelEntity(XName.Get("totalinclallodeductedra", "")));
            }
            ...
            public string totalallowancededucteddesc
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("totalallowancededucteddesc", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetElement(XName.Get("totalallowancededucteddesc", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public string totalallowancededucted
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("totalallowancededucted", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetElement(XName.Get("totalallowancededucted", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public string totalvatonallowancededucteddesc
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("totalvatonallowancededucteddesc", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetElement(XName.Get("totalvatonallowancededucteddesc", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public string totalvatonallowancededucted
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("totalvatonallowancededucted", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetElement(XName.Get("totalvatonallowancededucted", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public string totalinclallodeductedradesc
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("totalinclallodeductedradesc", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetElement(XName.Get("totalinclallodeductedradesc", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            public string totalinclallodeductedra
            {
                get
                {
                    XElement x = this.GetElement(XName.Get("totalinclallodeductedra", ""));
                    return XTypedServices.ParseValue<string>(x, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
                set
                {
                    this.SetElement(XName.Get("totalinclallodeductedra", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype);
                }
            }
            ...
            private static void BuildElementDictionary()
            {
                ...
                localElementDictionary.Add(XName.Get("totalallowancededucteddesc", ""), typeof(string));
                localElementDictionary.Add(XName.Get("totalallowancededucted", ""), typeof(string));
                localElementDictionary.Add(XName.Get("totalvatonallowancededucteddesc", ""), typeof(string));
                localElementDictionary.Add(XName.Get("totalvatonallowancededucted", ""), typeof(string));
                localElementDictionary.Add(XName.Get("totalinclallodeductedradesc", ""), typeof(string));
                localElementDictionary.Add(XName.Get("totalinclallodeductedra", ""), typeof(string));
            }
    ...
    public class LinqToXsdTypeManager : ILinqToXsdTypeManager
    {
        ...
        private static void BuildElementDictionary()
        {
            elementDictionary.Add(XName.Get("remittancedocument", ""), typeof(global::Spar.Data.XsdModels.RemittanceAdvice.OldDC.remittancedocument));
        }
