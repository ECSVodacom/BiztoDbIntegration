...
namespace Spar.Data.XsdModels.Claims
{
    ...
    public partial class Claims : XTypedElement, IXMetaData
    {
        ...
        /// <summary>
        /// <para>
        /// Regular expression: (Header, UNH, SAP, CLO, @REF, CRF, CLN*, CTR, CMS)
        /// </para>
        /// </summary>
        public partial class ClaimLocalType : XTypedElement, IXMetaData
        {
            ...
            public partial class CRFLocalType : XTypedElement, IXMetaData
            {
                ...
                /// <summary>
                /// <para>
                /// Regular expression: (ManClaimCode, InvNum?, InvDate, InvNumCode, CreditNum?, CreditDate?)
                /// </para>
                /// </summary>
            ...
            public partial class CLNLocalType : XTypedElement, IXMetaData
            {
                ...
                public partial class QuantityDetailsLocalType : XTypedElement, IXMetaData
                {
                    ...
                    /// </para>
                    /// </summary>
                    public sbyte NumberOfUnitsClaimed
                    {
                        get
                        {
                        ...
                        set
                        {
                            this.SetElement(XName.Get("NumberOfUnitsClaimed", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Byte).Datatype);
                        }
                    }
                    ...
                    /// </para>
                    /// </summary>
                    public sbyte ConsumerUnitsPerUnitsClaimed
                    {
                        get
                        {
                        ...
                        set
                        {
                            this.SetElement(XName.Get("ConsumerUnitsPerUnitsClaimed", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Byte).Datatype);
                        }
                    }
                    ...
                    /// </para>
                    /// </summary>
                    public sbyte LooseConsumerUnitsReturned
                    {
                        get
                        {
                        ...
                        set
                        {
                            this.SetElement(XName.Get("LooseConsumerUnitsReturned", ""), value, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Byte).Datatype);
                        }
                    }
                    ...
                    private static void BuildElementDictionary()
                    {
                        localElementDictionary.Add(XName.Get("NumberOfUnitsClaimed", ""), typeof(sbyte));
                        localElementDictionary.Add(XName.Get("ConsumerUnitsPerUnitsClaimed", ""), typeof(sbyte));
                        localElementDictionary.Add(XName.Get("LooseConsumerUnitsReturned", ""), typeof(sbyte));
                    }
                ...
                public partial class CreditAdjustmentsLocalType : XTypedElement, IXMetaData
                {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private XSimpleList<sbyte> PercentageField;
                    ...
                    /// </para>
                    /// </summary>
                    public IList<sbyte> Percentage
                    {
                        get
                        {
                            if ((this.PercentageField == null))
                            {
                                this.PercentageField = new XSimpleList<sbyte>(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Byte).Datatype, XName.Get("Percentage", ""));
                            }
                        ...
                        set
                        {
                            ...
                            else
                            {
                                if ((this.PercentageField == null))
                                {
                                    this.PercentageField = XSimpleList<sbyte>.Initialize(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.Byte).Datatype, value, XName.Get("Percentage", ""));
                                }
                                else
                                {
                                    XTypedServices.SetList<System.SByte>(this.PercentageField, value);
                                }
                            }
                        }
                    }
                    ...
                    private static void BuildElementDictionary()
                    {
                        ...
                        localElementDictionary.Add(XName.Get("Percentage", ""), typeof(sbyte));
